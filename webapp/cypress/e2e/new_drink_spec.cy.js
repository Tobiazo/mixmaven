...
describe('new drink page', () => {
    ...
    context("check input functionality", () => {
        it("should display errors when fields are wrong", () => {
            ...
            cy.get("#alcohol-percentage")
                .type("a")
            cy.wait(300)
            cy.get("#alcohol-percentage-error")
                .should("have.class", "visible")
                .should("have.text", "This field must be a postive number and max one dot")

            cy.get("#alcohol-percentage")
                .type("101") 
            cy.wait(300)
            cy.get("#alcohol-percentage-error")
                .should("have.text", "This field cannot be greater than 100")
